...
import { X, ArrowRight, ExternalLink, LifeBuoy, User, MessageSquare, Building2 } from "lucide-react";
...
const portals: Portal[] = [
    {
        ...
        icon: <User size={20} />,
        title: "Client Portal",
        description: "Access and manage your account details, view invoices, proposals, quotations, and memberships.",
    ...
    },
    {
        ...
        title: "SMS Portal",
        description: "Send, schedule, and manage your SMS campaigns with ease through our platform.",
...
const employeePortal = {
    ...
    description: "For internal team members to securely access company resources and tools.",
    ...
    return (
        <Sheet open={open} onOpenChange={setOpen}>
            ...
            >
                ...
                <SheetDescription className="sr-only">Select your portal to login</SheetDescription>
                {/* Header */}
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-xs text-gray-500 dark:text-white mt-0.5 leading-relaxed">
                                        If any of the above login links aren't working, please report an issue so we can assist you promptly.
                                    </p>
                                    <Link
...
function PortalCard({ portal, onClose }: { portal: Portal; onClose: () => void }) {
    return (
        <div className="group rounded-xl border border-gray-100 dark:border-white/10 bg-white dark:bg-white/3 hover:border-gray-200 dark:hover:border-white/20 hover:shadow-sm transition-all duration-200 overflow-hidden">
            <div className="p-4">
                <div className="flex items-start gap-3">
                    {/* Icon */}
                    <div className={`w-9 h-9 rounded-lg ${portal.iconBg} ${portal.iconBgDark} flex items-center justify-center ${portal.accent} ${portal.accentDark} shrink-0`}>
                        {portal.icon}
                    </div>
                    {/* Text */}
                    <div className="flex-1 min-w-0">
