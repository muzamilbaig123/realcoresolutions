...
export default function MainNav() {
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e: MouseEvent) => {
      ...
      const menuEl = megaMenuAreaRef.current;
    ...
    <>
      <div className="bg-transparent">
        <div className="container mx-auto px-4 lg:px-8 h-20 flex items-center justify-between gap-6">
          ...
          {/* Desktop Nav */}
          <nav ref={navAreaRef} className="hidden lg:flex items-center gap-0">
            {navMenus.map((menu) => (
              <div
                key={menu.trigger}
                ...
                >
                  ...
                  <ChevronDown
                    ...
                    className={`transition-transform duration-200 ${
                      activeMenu === menu.trigger ? "rotate-180" : ""
                    }`}
                  />
                </button>
              </div>
      ...
      {activeMenuData && (
        <div
          ref={megaMenuAreaRef}
          className="fixed left-1/2 -translate-x-1/2 top-[116px] z-50 w-full max-w-6xl px-4"
        >
          <div className="bg-white dark:bg-background border border-gray-100 dark:border-white/10 shadow-2xl rounded-xl overflow-hidden p-3">
